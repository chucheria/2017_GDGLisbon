...
Loading tidyverse will only give us the core of the collection (*tidyr*, *dplyr*, *ggplot2*, *tibble*, *purrr*), so if we need any other package along the example we will load it or call a standalone function when we need it.
